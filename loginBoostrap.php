...
<head>
    ...
    <!-- <link href="/docs/5.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-LN+7fdVzj6u52u30Kp6M/trliBMCMKTyK833zpbD+pXdCLuTusPj697FH4R/5mcr"> -->
...
<body class="d-flex align-items-center py-4 bg-body-tertiary"> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <main class="form-signin w-100 m-auto border borde-3 border-pramery rounded rounded-5 bg-white">
        <form> <div class="text-center"><img class="mb-4" src="https://usm.ac.id/wp-content/uploads/2022/09/Logo-USM-Color.png" alt="" width="100"></div>
