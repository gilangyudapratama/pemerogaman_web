            ...
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        ...
                        <ul class="nav flex-column mb-auto">
                            <li class="nav-item">
  <a class="nav-link" href="dashboardsetting.php">
    <i class="bi bi-gear"></i> Settings
                           ...
                           <li class="nav-item">
    <a class="nav-link d-flex align-items-center gap-2" href="logoutBoostrap.php" ;>
        ...
        Sign out
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <?php if (isset($_GET['update'])): ?>
                    ...
                    <?php elseif ($_GET['update'] == 'fail'): ?>
                        <div class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                            Gagal mengubah username atau password.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    <?php elseif ($_GET['update'] == 'empty'): ?>
